...
// Clase abstracta ThemeContainer
abstract class ThemeContainer : ContainerControl
{
    // Inicializacion
...
struct Bloom
{
    ...
    public string ValueHex
    {
        get
        {
            return string.Concat("#", _Value.R.ToString("X2", null), _Value.G.ToString("X2", null), _Value.B.ToString("X2", null));
        }
